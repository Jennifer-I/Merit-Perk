package com.jennifer.meritperk;

import com.jennifer.meritperk.domain.entities.SchoolEntity;
import com.jennifer.meritperk.usecase.services.impl.SchoolServiceImpl;
...
@EnableJpaAuditing
public class MeritPerkApplication {

    public static void main(String[] args) {
        SpringApplication.run(MeritPerkApplication.class, args);
    }
